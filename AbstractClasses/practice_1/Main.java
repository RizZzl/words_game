...
public class Main {
    ...
    private static void printLowestSalaries(Company company) {
        ...
        Iterator var1 = company.getLowestSalaryStaff(15).iterator();
    ...
    private static void printHighestSalaries(Company company) {
        ...
        Iterator var1 = company.getTopSalaryStaff(15).iterator();
    ...
    private static void fireHalfEmployees(Company company) {
        ...
        for(int i = 0; i < countEmployees / 2; ++i) {
            int index = (int)(Math.random() * (double)company.countEmployees());
            Employee loser = (Employee)company.getEmployees().get(index);
            company.fire(loser);
        }
