...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        jsonWriter.writeInJSONFile(metro.getMetroObject(), "C:/skillbox/dpo_java_basics/FilesAndNetwork/resourse/metro.json");
        JSONReader jsonReader = new JSONReader();
        jsonReader.getAmountOfStations("C:/skillbox/dpo_java_basics/FilesAndNetwork/resourse/metro.json");

        DataCollector collector = new DataCollector();
        collector.fileReader("C:/skillbox/dpo_java_basics/FilesAndNetwork/data");
        ...
        jsonWriter1.writeInJSONFile(stationObject, "C:/skillbox/dpo_java_basics/FilesAndNetwork/resourse/stations.json");
    }
